...
from util.Result import err, ok
...
def chat_repeat(cid):
    ...
    def callback(ai_text):
        print(1111111111111,ai_text,type(ai_text))
...
def init_logging():
    logfile_name = rf'C:\Users\Lenovo\Desktop\项目资料\chatai前后端\chatai-python-toGPT3.5/log/chat.txt'
...
def init_database():
    print(getopt.getopt(sys.argv[1:], 'u:p:', ["host=", "port=", "databaseName="]))
